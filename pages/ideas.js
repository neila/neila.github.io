                    ...
                    <section className="items-start lg:flex">
                        <div className="mx-auto space-y-5 leading-snug lg:w-4/5">
                            <p>
                                ...
                                . The raw thoughts that continuously pass
                                through my mind can only accumulate for so long.
                                Despite the constant mental wrestling, I feel
                                often left stranded in the ponderer's void, with
                                no wisdom to bear.
                            </p>
                            <p>
                                I find this quite unfortunate, since all
                                brilliant ideas are raw thoughts at the point of
                                its inception. I created this space to nurture
                                these seeds of imagination, so that they can
                                grow into something bigger. In the conscious and
                                continuous effort to acknolwedge and appreciate
                                the everchanging present, lies the art of
                                spontaneous creativity. I named this page after
                                the{' '}
                                <a
                            ...
                            <div className="relative mx-auto lg:w-3/5">
                                <blockquote className="relative border-l-4 p-4 text-center text-xl italic">
                                    ...
                                    <cite className="ml-16 text-base">
                                        - René Descartes
                                    </cite>
                                </blockquote>
                            </div>
                    ...
                    <ul className="flex flex-col space-y-2 px-0">
                        {postsList.map(({ id, date_created, tags }) => (
                            ...
                            >
                                <Link
                                    href={{
                                        pathname: `/ideas/${encodeURIComponent(
                                            id
                                        )}`,
                                    }}
                                >
                                    <div>
                                        <h3 className="truncate text-base lg:text-lg">
                                            {id}
                                        </h3>
