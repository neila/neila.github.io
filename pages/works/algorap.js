                ...
                <div className='px-2 justify-between flex relative'>
                    ...
                    <div className='h-full flex-grow relative text-[#F8DCAD]'>
                        ...
                        <div className="lg:w-4/6 2xl:w-1/2 lg:ml-32 2xl:ml-48 mt-10 2xl:mt-16 left-2">
                            ...
                            <p>
                                See <a href='https://drive.google.com/drive/folders/13w_n7UNzEaPrk6yLpNp_0GsYC9sB8-I7?usp=sharing' className="hover:text-[#FE0000]" target="_blank">here</a> for more examples of the generated lyrics. 
                            </p>
                            <br />
                            ...
                            <p className="text-center p-3 text-[#60A5FA]">
                                <a href="https://drive.google.com/file/d/1rGHbY77GsPKjaz7iGXGG8GcbK6YgHfCs/view?usp=sharing" className="hover:text-[#FE0000]" target="_blank">Top layer (most coarse)</a> &nbsp;&nbsp;&nbsp;
                                <a href="https://drive.google.com/file/d/1dYaSYmoiFRly4UHiXboThcEkR6AG794D/view?usp=sharing" className="hover:text-[#FE0000]" target="_blank">Middle layer</a> &nbsp;&nbsp;&nbsp;
                                <a href="https://drive.google.com/file/d/1zCJPl7INAitD8bbsQG0vylZ3Vnw-Y5gY/view?usp=sharing" className="hover:text-[#FE0000]" target="_blank">Bottom layer (least coarse)</a>
                            </p>
                            <p>
                            ...
                            <p>
                                ...
                                It can be accessed via this <b><a href="https://drive.google.com/drive/folders/14UNyi2h6KXJwaVIbGr9zz5nVQomnJtae?usp=sharing" className="text-[#FE0000]" target="_blank">ALBUM LINK</a></b>. 
