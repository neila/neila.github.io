  ...
  return (
    <BaseLayout pageTitle="About this website">
      <article className="laptop:max-w-6xl mx-auto">
        ...
        <h2 id={useId()}>Design</h2>
        <h3 id={useId()}>Custom links</h3>
        <p>
          I use custom{' '}
          <LinkWithIcon
            ...
            text="links"
          />{' '}
          to make the link destination immediately visible even before visiting
          the page. It also makes the text in this site look more interesting
          and exploratory. I like to link many external sources when I write,
          and it would be better to make it easy for you to find them.
        </p>
