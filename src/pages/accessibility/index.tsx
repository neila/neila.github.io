        ...
        <BaseLayout pageTitle="Accessibility" className="px-4">
          ...
          <section id="accessibility">
            ...
            <p>
              ...
              <br />
              Progressive Enhacement: Pages can be read on various screen
              widths; monitors, tablets, and smartphones alike. It even works on
              a text browser like <a href="https://www.brow.sh/">browsh</a>.
            </p>
          </section>
        </BaseLayout>
      </article>
